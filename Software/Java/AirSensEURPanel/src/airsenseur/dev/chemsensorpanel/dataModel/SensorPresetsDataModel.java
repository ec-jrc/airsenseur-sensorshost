 ...
 * @author marco
 */
public class SensorPresetsDataModel extends DefaultComboBoxModel {
    
    public SensorPresetsDataModel() throws PresetException {
        super(SensorDbFactory.getInstance().getPresets().toArray());
    }
}
