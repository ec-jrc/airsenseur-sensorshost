...
public class AD5694RPanel extends PresetDrivenPanel {
    ...
    public void storeToBoard(int channelId) {
        storeToBoard(channelId, dacModelA);
        storeToBoard(channelId, dacModelB);
        storeToBoard(channelId, dacModelC);
    }
    
    private void storeToBoard(int channelId, DACChannelDataModel dataModel) {
        ...
        CommProtocolHelper.instance().renderDAC5694RegSetup(channelId, subChannel, value, gain);
    }
    
    public void readFromBoard(int channelId) {
        CommProtocolHelper helper = CommProtocolHelper.instance();
        
        helper.renderDAC5694ReadSetup(channelId, IDDAC_A);
        helper.renderDAC5694ReadSetup(channelId, IDDAC_B);
        helper.renderDAC5694ReadSetup(channelId, IDDAC_C);
    }
    ...
    public void evaluateRxMessage(CommProtocolHelper.DataMessage rxMessage, int channelId) {
        ...
        registers = helper.evalDACRegistersInquiry(rxMessage, channelId);
