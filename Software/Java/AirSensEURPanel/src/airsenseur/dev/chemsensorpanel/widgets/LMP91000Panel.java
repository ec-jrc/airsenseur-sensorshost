...
public class LMP91000Panel extends PresetDrivenPanel {
    ...
    public void readFromBoard() throws SensorBusException {
        ...
        shieldProtocolLayer.renderReadSensorSerialNumber(boardId, channelId);
    }
    ...
    public void evaluateRxMessage(AppDataMessage rxMessage) {
        ...
        // Setup name
        String setupName = shieldProtocolLayer.evalSensorInquiry(rxMessage, boardId, channelId);
        if ((setupName != null) && !setupName.isEmpty()) {
            jTxtName.setText(setupName);
        }
    ...
    public void onDataMessageFromConfiguration(AppDataMessage rxMessage) {
        ...
        String setupName = shieldProtocolLayer.evalSensorInquiry(rxMessage, boardId, channelId);
        if ((setupName != null) && !setupName.isEmpty()) {
            ((JOverridableTextField)jTxtName).setTextOverride(setupName);
        }
    ...
    private void evaluateOherFields(AppDataMessage rxMessage) {
        
        // Tia, Ref, mode registers
        List<Integer> registers;
        registers = shieldProtocolLayer.evalAFERegistersInquiry(rxMessage, boardId, channelId);
    ...
    private void initComponents() {
        ...
        jTxtName = new JOverridableTextField();
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            .addComponent(jCBGain, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.PREFERRED_SIZE, 117, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addComponent(jCBLoad, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.PREFERRED_SIZE, 117, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addComponent(jTxtName, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.PREFERRED_SIZE, 117, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addComponent(jCBVSrc, javax.swing.GroupLayout.PREFERRED_SIZE, 117, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addComponent(jCBIntZ, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.PREFERRED_SIZE, 117, javax.swing.GroupLayout.PREFERRED_SIZE))
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(jCBBiasPol, 0, 128, Short.MAX_VALUE)
                            .addComponent(jCBBiasPerc, 0, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                            .addComponent(jCBFetShort, 0, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
